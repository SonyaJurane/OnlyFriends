                ...
                <div class="box-login">
                    ...
                    <form method="post" action="validation.php">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" style="background-color:#F1C21B;" class="btn" name="reg_user">Login</button>
                        </div>
                        <br>
                        <p style="text-align:center">Make an account: <a href="../register/signup.php">Sign Up</a></p>
                    </form>
                </div>
            </div>
        </div>
