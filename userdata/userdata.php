      ...
      <div class="col-sm-12">
        <div class="box-userdata">
          <form name="form" method="post" action="reguserdata.php" onsubmit="return validateForm(event)">
            <div class="row">
              <div class="col-sm-12">
                <h2 class="h2-userdata">Create Profile</h2>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <h3 class="h3-userdata">My info</h3>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4">
                ...
                <!--Get user's city location as well as their longitude and latitude-->
            ...
            <div class="row">
              <div class="col-sm-12">
                <!--Get who user is looking for -->
                <h3 class="h3-userdata">I am looking for...</h3>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4">
            ...
            <div class="row justify-content-center">
              <div class="col-sm-12 text-center"><button type="submit" class="btn btn-userdata" name="reg_user">Sign up</button></div>
            </div>
          </form>
        </div>
      </div>
